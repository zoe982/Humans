...
const MIGRATION_STATEMENTS = [
  ...
  `CREATE TABLE IF NOT EXISTS "human_evacuation_leads" (
    "id" text PRIMARY KEY NOT NULL,
    "human_id" text NOT NULL,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS "human_evacuation_leads_evacuation_lead_id_unique" ON "human_evacuation_leads" ("evacuation_lead_id")`,
  `CREATE INDEX IF NOT EXISTS "activities_evacuation_lead_id_idx" ON "activities" ("evacuation_lead_id")`,
  `CREATE INDEX IF NOT EXISTS "lead_scores_evacuation_lead_id_idx" ON "lead_scores" ("evacuation_lead_id")`,
  `CREATE INDEX IF NOT EXISTS "emails_evacuation_lead_id_idx" ON "emails" ("evacuation_lead_id")`,
  `CREATE INDEX IF NOT EXISTS "phones_evacuation_lead_id_idx" ON "phones" ("evacuation_lead_id")`,
  `CREATE INDEX IF NOT EXISTS "social_ids_evacuation_lead_id_idx" ON "social_ids" ("evacuation_lead_id")`,
