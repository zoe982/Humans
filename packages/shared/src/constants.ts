...
export const SESSION_REFRESH_THRESHOLD_SECONDS = 21600; // 6 hours — only refresh KV TTL if older
...
export const PERMISSIONS = {
  ...
  viewWebsiteBookingRequests: ["agent", "manager", "admin"],
  manageWebsiteBookingRequests: ["manager", "admin"],
  deleteWebsiteBookingRequests: ["admin"],
  deleteHumans: ["admin"],
  ...
  viewGeneralLeads: ["agent", "manager", "admin"],
  manageGeneralLeads: ["agent", "manager", "admin"],
  deleteGeneralLeads: ["admin"],
  viewFlights: ["agent", "manager", "admin"],
  manageFlights: ["manager", "admin"],
